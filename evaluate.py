...
def print_table():
    ...
    algs = ['WSS', 'BSCA', 'MB+', 'MST', 'MR', 'HS']
    # algs = ['WSS', 'LEGS', 'RFCN', 'DCL', 'DHS', 'MCDL', 'MDF']
    # algs = ['Ours_cap', 'Ours_cls', 'Ours_woAux', 'Ours_woUn', 'Ours_woDeeplab', 'Ours']
    # datasets = ['ECSSD', 'PASCALS', 'SOD', 'MSRA5K', 'OMRON']
    # algs = ['Ours_woDeeplab', 'Ours_ps_woDeeplab']
    datasets = ['SED1']
    for alg in algs:
        print(alg + '& ', end='')
...
if __name__ == '__main__':
    # dset = 'HKU-IS'
    # fm, mae, _, _ = fm_and_mae('/home/zeng/data/datasets/saliency_Dataset/results/HKU-IS-Sal/WSS',
    #                            '/home/zeng/data/datasets/saliency_Dataset/%s/masks'%dset)
    # dsets = os.listdir('results')
    # for dset in dsets:
    #     fm, mae, _, _ = fm_and_mae('./results/%s'%dset,
